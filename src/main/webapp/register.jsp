...
<script>
    $(function(){
        $(".validate_btn").click(function (){
            $.ajax({
                url: "YzmServlet?uphone="+$("#userTel").val(),
                type: 'get',
                dataType: 'text',
                success:function (){
                    alert("短信发送成功")
...
<div class="wrapper">
    ...
    <div class="header_nav">
        <div class="main_width">
            <h1><a href="index.jsp" class="logo fl">大特保保险官网-互联网保险服务平台</a></h1>
...
">首页</a></li>
    ...
    <div class="container">
        <div class="login_bg">
            <div class="form">
                <form  action="RegisterServlet" name="loginForm" id="loginForm">
                    <h2>注册阳光保险</h2>
                    <%-- <div class="user_box">
                    ...
                    <div class="tel_box">
                        <span class="icon"></span>
                        <input type="text" class="userTel" name="uphone" id="userTel" placeholder="请输入您的手机号" maxlength="11" onkeyup = "value=value.replace(/[^\d]/g,'')">
                    </div>
                    <div class="pwd_box">
                        <span class="icon"></span>
                    ...
                    <div class="pwd_box">
                        <span class="icon"></span>
                        <input type="password" class="userPwd"  name="upwd1" placeholder="确认密码">
                    </div>

                    <div class="validate_box">

                        <input type="text" class="validate" name="yzm" placeholder="请输入验证码"><input type="button"  value="发送验证码" class="validate_btn" id="validate_btn">
                    </div>
                    ...
                    <div>
                        <input type="submit" class="login_btn" id="loginBtn">注册</input>
                        <%--<input type="submit" class="login_btn" id="loginBtn" value="注册">--%>
                    </div>
                </form>
            </div>
        </div>
